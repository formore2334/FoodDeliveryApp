...
extension Menu {
    static let mockData: [Menu] = [
        Menu(imageName: "comboLogo", title: "Combo", description: "Nice food", menuItem: [
            ...
            DiscountMenuItem(sale: 15, price: 13.99, imageURL: "https://img.freepik.com/free-photo/high-angle-set-burgers-wooden-board_23-2148290590.jpg?w=740&t=st=1700538078~exp=1700538678~hmac=02a6a28424b525e6f92faed04d22fdca3515a8b5d5d6d73d9333d87a85ced7c8", title: "Combo 4", description: "Good Choise to.."),
        ...
        Menu(imageName: "burgerLogo", title: "Burgers", description: "Nice food", menuItem: [
            ...
            SpecialSaleMenuItem(sale: 10, price: 9.99, imageURL: "https://img.freepik.com/free-photo/front-view-burger-table_23-2148678799.jpg?size=626&ext=jpg&uid=R126075889&ga=GA1.1.94238438.1700466765&semt=sph", title: "Burger 2", description: "Good Choise to.."),
